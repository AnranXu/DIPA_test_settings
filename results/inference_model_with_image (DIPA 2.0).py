...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project="concern question test (uncompleted collection)", name = 'no concern questions (Resnet 50)')
    checkpoint_callback = ModelCheckpoint(dirpath='./models/no concern questions (Resnet 50)/', save_last=True, monitor='val loss')
